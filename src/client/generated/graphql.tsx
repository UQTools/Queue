...
export type GetCoursesQuery = { __typename?: "Query" } & {
    getCourses: Array<
        { __typename?: "Course" } & Pick<Course, "code" | "id" | "title">
    >;
};
...
export type AddCourseStaffMutation = { __typename?: "Mutation" } & {
    addStaff: Array<
        { __typename?: "CourseStaff" } & Pick<CourseStaff, "id" | "role"> & {
                user: { __typename?: "User" } & Pick<User, "username" | "name">;
            }
    >;
};
...
export type GetCourseStaffQuery = { __typename?: "Query" } & {
...
export type AddStudentEnrolmentMutationVariables = Exact<{
    ...
    userEnrolledSessions:
        | Array<UserEnrolledSessionInput>
        | UserEnrolledSessionInput;
}>;

export type AddStudentEnrolmentMutation = { __typename?: "Mutation" } & {
    addStudentEnrolment: Array<
        { __typename?: "CourseUserMeta" } & Pick<
            CourseUserMeta,
            "enrolledSession"
...
export type QuestionChangeSubscription = { __typename?: "Subscription" } & {
    questionChanges: { __typename?: "Question" } & Pick<
        Question,
        | "id"
        | "status"
        | "createdTime"
    ...
    > & {
            ...
            >;
            queue: { __typename?: "Queue" } & Pick<Queue, "id">;
        };
};
...
export type UndoRemoveMutation = { __typename?: "Mutation" } & {
    undoRemove: { __typename?: "Question" } & Pick<
        Question,
        | "id"
        | "status"
        | "createdTime"
...
export type AskQuestionMutation = { __typename?: "Mutation" } & {
    askQuestion: { __typename?: "Question" } & Pick<
        Question,
        "id" | "status" | "createdTime" | "questionsAsked" | "enrolledIn"
    > & {
            op: { __typename?: "User" } & Pick<
                User,
                "email" | "name" | "username"
...
export type UpdateQuestionStatusMutation = { __typename?: "Mutation" } & {
    updateQuestionStatus: { __typename?: "Question" } & Pick<
        Question,
        "id" | "status" | "createdTime" | "questionsAsked" | "enrolledIn"
    > & {
            op: { __typename?: "User" } & Pick<
...
export type UpdateQueueMutation = { __typename?: "Mutation" } & {
    updateQueue: { __typename?: "Queue" } & Pick<
        Queue,
        | "id"
        | "name"
        | "shortDescription"
...
export type CreateQueueMutation = { __typename?: "Mutation" } & {
    createQueue: { __typename?: "Queue" } & Pick<
        Queue,
        | "id"
        | "name"
        | "shortDescription"
...
export type RemoveQueueMutation = { __typename?: "Mutation" } & Pick<
    Mutation,
    "removeQueue"
>;
...
export type GetActiveRoomsQuery = { __typename?: "Query" } & {
    getActiveRooms: Array<{ __typename?: "Room" } & Pick<Room, "id" | "name">>;
};
...
export type GetRoomByIdQuery = { __typename?: "Query" } & {
    getRoomById: { __typename?: "Room" } & Pick<Room, "id" | "name"> & {
            queues: Array<
                { __typename?: "Queue" } & Pick<
                    Queue,
                    | "id"
                    | "name"
                    | "shortDescription"
...
export type UpdateRoomMutation = { __typename?: "Mutation" } & {
    updateRoom: { __typename?: "Room" } & Pick<
        Room,
        "id" | "name" | "capacity" | "enforceCapacity" | "manuallyDisabled"
    > & {
            activeTimes: Array<
                { __typename?: "WeeklyEvent" } & Pick<
                    WeeklyEvent,
...
export type AddRoomMutation = { __typename?: "Mutation" } & {
    createRoom: { __typename?: "Room" } & Pick<
        Room,
        "id" | "name" | "capacity" | "enforceCapacity" | "manuallyDisabled"
    > & {
            activeTimes: Array<
...
export type DeleteRoomMutation = { __typename?: "Mutation" } & Pick<
    Mutation,
    "deleteRoom"
>;
 ...
 * });
 */
export function useGetCourseStaffQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetCourseStaffQuery,
        GetCourseStaffQueryVariables
    >
) {
    return Apollo.useQuery<GetCourseStaffQuery, GetCourseStaffQueryVariables>(
        GetCourseStaffDocument,
        baseOptions
    );
}
export function useGetCourseStaffLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GetCourseStaffQuery,
        GetCourseStaffQueryVariables
    >
    ...
    return Apollo.useLazyQuery<
        GetCourseStaffQuery,
        GetCourseStaffQueryVariables
    >(GetCourseStaffDocument, baseOptions);
}
export type GetCourseStaffQueryHookResult = ReturnType<
    typeof useGetCourseStaffQuery
>;
export type GetCourseStaffLazyQueryHookResult = ReturnType<
    typeof useGetCourseStaffLazyQuery
>;
export type GetCourseStaffQueryResult = Apollo.QueryResult<
    GetCourseStaffQuery,
    GetCourseStaffQueryVariables
>;
...
`;
export type AddStudentEnrolmentMutationFn = Apollo.MutationFunction<
    AddStudentEnrolmentMutation,
    AddStudentEnrolmentMutationVariables
>;
 ...
 * });
 */
export function useAddStudentEnrolmentMutation(
    baseOptions?: Apollo.MutationHookOptions<
        AddStudentEnrolmentMutation,
        AddStudentEnrolmentMutationVariables
    >
    ...
    return Apollo.useMutation<
        AddStudentEnrolmentMutation,
        AddStudentEnrolmentMutationVariables
    >(AddStudentEnrolmentDocument, baseOptions);
}
export type AddStudentEnrolmentMutationHookResult = ReturnType<
    typeof useAddStudentEnrolmentMutation
>;
export type AddStudentEnrolmentMutationResult = Apollo.MutationResult<AddStudentEnrolmentMutation>;
export type AddStudentEnrolmentMutationOptions = Apollo.BaseMutationOptions<
    AddStudentEnrolmentMutation,
    AddStudentEnrolmentMutationVariables
>;
 ...
 * });
 */
export function useQuestionChangeSubscription(
    baseOptions: Apollo.SubscriptionHookOptions<
        QuestionChangeSubscription,
        QuestionChangeSubscriptionVariables
    >
) {
    return Apollo.useSubscription<
        QuestionChangeSubscription,
        QuestionChangeSubscriptionVariables
    >(QuestionChangeDocument, baseOptions);
}
export type QuestionChangeSubscriptionHookResult = ReturnType<
    typeof useQuestionChangeSubscription
>;
...
`;
export type UndoRemoveMutationFn = Apollo.MutationFunction<
    UndoRemoveMutation,
    UndoRemoveMutationVariables
>;
 ...
 * });
 */
export function useUndoRemoveMutation(
    baseOptions?: Apollo.MutationHookOptions<
        UndoRemoveMutation,
        UndoRemoveMutationVariables
    >
) {
    return Apollo.useMutation<UndoRemoveMutation, UndoRemoveMutationVariables>(
        UndoRemoveDocument,
        baseOptions
    );
}
export type UndoRemoveMutationHookResult = ReturnType<
    typeof useUndoRemoveMutation
>;
export type UndoRemoveMutationResult = Apollo.MutationResult<UndoRemoveMutation>;
export type UndoRemoveMutationOptions = Apollo.BaseMutationOptions<
    UndoRemoveMutation,
    UndoRemoveMutationVariables
>;
...
export function useAskQuestionMutation(
    ...
    return Apollo.useMutation<
        AskQuestionMutation,
        AskQuestionMutationVariables
    >(AskQuestionDocument, baseOptions);
}
...
`;
export type UpdateQuestionStatusMutationFn = Apollo.MutationFunction<
    UpdateQuestionStatusMutation,
    UpdateQuestionStatusMutationVariables
>;
...
export function useUpdateQuestionStatusMutation(
    ...
    return Apollo.useMutation<
        UpdateQuestionStatusMutation,
        UpdateQuestionStatusMutationVariables
    >(UpdateQuestionStatusDocument, baseOptions);
}
export type UpdateQuestionStatusMutationHookResult = ReturnType<
    typeof useUpdateQuestionStatusMutation
>;
export type UpdateQuestionStatusMutationResult = Apollo.MutationResult<UpdateQuestionStatusMutation>;
export type UpdateQuestionStatusMutationOptions = Apollo.BaseMutationOptions<
    UpdateQuestionStatusMutation,
    UpdateQuestionStatusMutationVariables
>;
...
`;
export type UpdateQueueMutationFn = Apollo.MutationFunction<
    UpdateQueueMutation,
...
export function useUpdateQueueMutation(
    ...
    return Apollo.useMutation<
        UpdateQueueMutation,
        UpdateQueueMutationVariables
    >(UpdateQueueDocument, baseOptions);
}
export type UpdateQueueMutationHookResult = ReturnType<
    typeof useUpdateQueueMutation
>;
export type UpdateQueueMutationResult = Apollo.MutationResult<UpdateQueueMutation>;
export type UpdateQueueMutationOptions = Apollo.BaseMutationOptions<
    UpdateQueueMutation,
    UpdateQueueMutationVariables
>;
...
`;
export type CreateQueueMutationFn = Apollo.MutationFunction<
    CreateQueueMutation,
...
export function useCreateQueueMutation(
    ...
    return Apollo.useMutation<
        CreateQueueMutation,
        CreateQueueMutationVariables
    >(CreateQueueDocument, baseOptions);
}
export type CreateQueueMutationHookResult = ReturnType<
    typeof useCreateQueueMutation
>;
export type CreateQueueMutationResult = Apollo.MutationResult<CreateQueueMutation>;
export type CreateQueueMutationOptions = Apollo.BaseMutationOptions<
    CreateQueueMutation,
    CreateQueueMutationVariables
>;
...
`;
export type RemoveQueueMutationFn = Apollo.MutationFunction<
    RemoveQueueMutation,
    RemoveQueueMutationVariables
>;
 ...
 * });
 */
export function useRemoveQueueMutation(
    baseOptions?: Apollo.MutationHookOptions<
        RemoveQueueMutation,
        RemoveQueueMutationVariables
    >
    ...
    return Apollo.useMutation<
        RemoveQueueMutation,
        RemoveQueueMutationVariables
    >(RemoveQueueDocument, baseOptions);
}
export type RemoveQueueMutationHookResult = ReturnType<
    typeof useRemoveQueueMutation
>;
export type RemoveQueueMutationResult = Apollo.MutationResult<RemoveQueueMutation>;
export type RemoveQueueMutationOptions = Apollo.BaseMutationOptions<
    RemoveQueueMutation,
    RemoveQueueMutationVariables
>;
...
export function useGetActiveRoomsLazyQuery(
    ...
    return Apollo.useLazyQuery<
        GetActiveRoomsQuery,
        GetActiveRoomsQueryVariables
    >(GetActiveRoomsDocument, baseOptions);
}
...
`;
export type AddRoomMutationFn = Apollo.MutationFunction<
    AddRoomMutation,
...
export function useAddRoomMutation(
    ...
    return Apollo.useMutation<AddRoomMutation, AddRoomMutationVariables>(
        AddRoomDocument,
        baseOptions
    );
}

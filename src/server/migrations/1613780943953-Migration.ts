...
export class Migration1613780943953 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE "course_user_meta" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "questionsAsked" integer NOT NULL, "date" TIMESTAMP NOT NULL, "userId" uuid, "courseId" uuid, CONSTRAINT "PK_225bd37760daf7c2c284ba98484" PRIMARY KEY ("id"))'
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            'CREATE TABLE "weekly_event" ("id" SERIAL NOT NULL, "startTime" integer NOT NULL, "endTime" integer NOT NULL, "roomId" uuid, CONSTRAINT "PK_8d1a1a9292c5bfec77c21270e67" PRIMARY KEY ("id"))'
        );
        await queryRunner.query(
            'CREATE TABLE "room" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "capacity" integer NOT NULL, "enforceCapacity" boolean NOT NULL, "manuallyDisabled" boolean NOT NULL, "courseId" uuid, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))'
        );
        await queryRunner.query(
            'CREATE TABLE "course" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying NOT NULL, "title" character varying NOT NULL, CONSTRAINT "UQ_5cf4963ae12285cda6432d5a3a4" UNIQUE ("code"), CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id"))'
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            'ALTER TABLE "weekly_event" ADD CONSTRAINT "FK_5c3ad51d0475eb3dab721d0b9d7" FOREIGN KEY ("roomId") REFERENCES "room"("id") ON DELETE NO ACTION ON UPDATE NO ACTION'
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'ALTER TABLE "weekly_event" DROP CONSTRAINT "FK_5c3ad51d0475eb3dab721d0b9d7"'
        );
        await queryRunner.query(
